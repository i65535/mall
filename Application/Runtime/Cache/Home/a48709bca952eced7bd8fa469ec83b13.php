...
<script type="text/javascript" src="/Public/pc/style/js/jquery.lightbox-0.5.min.js"></script>
<script type="text/javascript">
    $(function() {
        $('.zoombut').lightBox();
    });
...
<div class="fy" style=" background:url(http://0001543.ks.panguweb.cn/upfile/ads/20150804113438-369103644.jpg) center top no-repeat;">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/index.php/Home/Carlist/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/index.php/Home/Carlist/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
        ...
        <div class="fyRight">
    		    ...
    		    <ul class="proul">
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <a href="/index.php/Home/Article/index/arid/<?php echo ($vo["id"]); ?>" title="车型：<?php echo ($vo["title"]); ?>">
                        	<p class="casetitle1" ><span title="车型：<?php echo ($vo["title"]); ?>" href="<?php echo ($vo["pic"]); ?>" class="zoombut"></span><span class="jianjie">车型：<?php echo ($vo["title"]); ?></span> </p> 
